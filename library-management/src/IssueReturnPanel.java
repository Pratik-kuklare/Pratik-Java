...
public class IssueReturnPanel extends JPanel {
    ...
    private void loadBooks() {
        ...
        try {
            ...
            // Add placeholder item when database is not connected
            Book placeholder = new Book();
            placeholder.setTitle("Database not connected");
            placeholder.setAuthor("Setup MySQL connection");
            bookCombo.addItem(placeholder);
        }
    }
    ...
    private void loadUsers() {
        ...
        try {
            ...
            placeholder.setName("Database not connected");
            placeholder.setEmail("setup@mysql.connection");
    ...
    private void loadIssues() {
        ...
        try {
            ...
            // Add placeholder row when database is not connected
            Object[] row = {"N/A", "Database not connected", "Setup MySQL connection", "", "", "", ""};
            tableModel.addRow(row);
        }
    }
